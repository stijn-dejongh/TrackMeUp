...
public class ManagerContainer extends Controller {
  ...
  ManagerContainer() {
    ...
    try {
      ...
      Optional<String> todoLocation = configManager
      ...
      Optional<String> timeLocation = configManager
      ...
      Optional<String> notesLocation = configManager
  ...
  public boolean isSetFileOptions() {
    return configManager.containsProperty(DisplayConstants.NAME_PROPERTY_TODO_LOCATION)
        || configManager

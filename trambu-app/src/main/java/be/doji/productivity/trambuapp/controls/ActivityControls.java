...
public class ActivityControls extends TitledPane {
  ...
  private Button createAddActivityButton() {
    ...
    addActivity
        .setTooltip(DisplayUtils.createTooltip(TooltipConstants.TOOLTIP_TEXT_CONTROL_CREATE));
    return addActivity;
  }

  @NotNull
  private Button createResetFilterButton() {
    ...
    resetFilter
        .setTooltip(DisplayUtils.createTooltip(TooltipConstants.TOOLTIP_TEXT_CONTROL_FILTER_RESET));
    return resetFilter;
  }

  @NotNull
  private Button createFilterCompletedButton() {
    ...
    filterButton
        .setTooltip(DisplayUtils.createTooltip(TooltipConstants.TOOLTIP_TEXT_CONTROL_FILTER_DONE));
    return filterButton;
  }
